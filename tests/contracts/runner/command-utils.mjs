...
export function parseRunnerArgs(argv) {
    ...
    if (!["all", "http", "package"].includes(options.area)) {
...
export function printHelp() {
    process.stdout.write(`Usage: node tests/contracts/runner/contract-runner.mjs --area http|package|all --tier pr|extended|torture [--format json|markdown] [--out path]
