...
export function parseRunnerArgs(argv) {
    ...
    if (!["all", "http", "openapi", "package"].includes(options.area)) {
...
export function printHelp() {
    process.stdout.write(`Usage: node tests/contracts/runner/contract-runner.mjs --area http|openapi|package|all --tier pr|extended|torture [--format json|markdown] [--out path]
