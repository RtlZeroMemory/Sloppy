...
export function parseRunnerArgs(argv) {
    ...
    if (!["all", "package", "webhooks"].includes(options.area)) {
...
export function printHelp() {
    process.stdout.write(`Usage: node tests/contracts/runner/contract-runner.mjs --area package|webhooks|all --tier pr|extended|torture [--format json|markdown] [--out path]
