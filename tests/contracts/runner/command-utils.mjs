...
export function parseRunnerArgs(argv) {
    ...
    if (!["all", "package", "realtime"].includes(options.area)) {
...
export function printHelp() {
    process.stdout.write(`Usage: node tests/contracts/runner/contract-runner.mjs --area package|realtime|all --tier pr|extended|torture [--format json|markdown] [--out path]
