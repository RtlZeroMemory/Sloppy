...
static int test_http_code_names(void)
{
    static const ExpectedDiagCodeName expected[] = {
        {SL_DIAG_HTTP_HEADER_LIMIT, "SLOPPY_E_HTTP_HEADER_LIMIT"},
        {SL_DIAG_HTTP_UNSUPPORTED_METHOD, "SLOPPY_E_HTTP_UNSUPPORTED_METHOD"},
        {SL_DIAG_HTTP_ROUTE_NOT_FOUND, "SLOPPY_E_HTTP_ROUTE_NOT_FOUND"},
        ...
        {SL_DIAG_HTTP_REQUEST_LINE_LIMIT, "SLOPPY_E_HTTP_REQUEST_LINE_LIMIT"},
        ...
        {SL_DIAG_HTTP_SHUTDOWN, "SLOPPY_E_HTTP_SHUTDOWN"},
        ...
        {SL_DIAG_HTTP_DISPATCH_FAILED, "SLOPPY_E_HTTP_DISPATCH_FAILED"},
        {SL_DIAG_HTTP_RESPONSE_SERIALIZATION_FAILED, "SLOPPY_E_HTTP_RESPONSE_SERIALIZATION_FAILED"},
        {SL_DIAG_HTTP_WRITE_FAILED, "SLOPPY_E_HTTP_WRITE_FAILED"},
        {SL_DIAG_HTTP_CLOSE_FAILED, "SLOPPY_E_HTTP_CLOSE_FAILED"},
        {SL_DIAG_HTTP_KEEP_ALIVE_IDLE_TIMEOUT, "SLOPPY_E_HTTP_KEEP_ALIVE_IDLE_TIMEOUT"},
        {SL_DIAG_HTTP_MAX_REQUESTS_REACHED, "SLOPPY_E_HTTP_MAX_REQUESTS_REACHED"},
        {SL_DIAG_HTTP_PIPELINING_UNSUPPORTED, "SLOPPY_E_HTTP_PIPELINING_UNSUPPORTED"},
        {SL_DIAG_HTTP_CHUNK_SIZE_INVALID, "SLOPPY_E_HTTP_CHUNK_SIZE_INVALID"},
        {SL_DIAG_HTTP_CHUNK_SIZE_OVERFLOW, "SLOPPY_E_HTTP_CHUNK_SIZE_OVERFLOW"},
        {SL_DIAG_HTTP_CHUNK_DELIMITER_INVALID, "SLOPPY_E_HTTP_CHUNK_DELIMITER_INVALID"},
...
static int test_stable_code_registry_complete(void)
{
    ...
    for (; value <= (size_t)SL_DIAG_RELEASE_ARTIFACT_MISMATCH; value += 1U) {
    ...
    if (expect_str_equal(
            sl_diag_code_name((SlDiagCode)((size_t)SL_DIAG_RELEASE_ARTIFACT_MISMATCH + 1U)),
            sl_str_from_cstr("SLOPPY_E_UNKNOWN")) != 0)
    {
        return 54;
    }
