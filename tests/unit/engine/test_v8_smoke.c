    ...
    if (expect_status(
            sl_engine_eval_source(
                ...
                sl_str_from_cstr(
                    ...
                    " if (handle.slot !== undefined || handle.generation !== undefined || "
                    "Object.keys(handle).includes('slot')) {"
                    ...
                    " if (watcher.slot !== undefined || watcher.generation !== undefined || "
                    "Object.keys(watcher).includes('generation')) {"
    ...
    if (expect_status(
            sl_engine_eval_source(
                ...
                sl_str_from_cstr(
                    ...
                    "  if (db.slot !== undefined || db.generation !== undefined || "
                    "Object.keys(db).includes('slot')) {"
