...
Integration evidence is lane-specific. Default non-V8 integration can validate artifact
validation, source-input compiler handoff, and clear unsupported diagnostics. V8-gated
integration validates execution only when the V8 SDK lane is configured. Package
