...
The `examples.hello.api_shape` and `examples.ergonomics.api_shape` CTest checks statically
verify the public examples use the current bootstrap API shape without requiring Node, npm,
compiler extraction, app-plan emission, or HTTP runtime behavior.
