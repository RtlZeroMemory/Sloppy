...
static const SlBenchDefinition v8_bridge_definitions[] = {
    {"v8.startup.create.core_only", "v8-bridge",
     ...
     "internal startup evidence only; includes isolate/context and root intrinsic setup", true, 0U, 0U},
    {"v8.startup.create.app_http", "v8-bridge",
     ...
     "internal startup evidence only; not request throughput or public performance data", true, 0U, 0U},
    ...
    {"v8.bridge.native.crypto_primitive", "v8-bridge",
     ...
     "includes random backend cost; used as bridge evidence, not crypto throughput data", true, 0U, 0U},
    {"v8.bridge.native.crypto_bytes", "v8-bridge",
     ...
     "exercises byte argument conversion and native text result conversion", true, 0U, 0U},
    ...
    {"v8.bridge.result.primitive_json", "v8-bridge",
     ...
     "internal result-conversion evidence; no public response throughput claim", true, 0U, 0U},
    {"v8.bridge.result.string_utf8", "v8-bridge",
     "copy a UTF-8 JavaScript string result into arena-owned native storage", 1000U, 10000U,
     sl_bench_v8_result_string_utf8, "exercises string conversion and result arena copy", true, 0U, 0U},
    ...
    {"v8.bridge.promise.reject_error", "v8-bridge",
     ...
     "expected rejection is counted as the measured outcome", true, 0U, 0U},
    {"v8.bridge.options.invalid_result_header", "v8-bridge",
     ...
     "expected invalid descriptor is counted as the measured outcome", true, 0U, 0U},
    {"v8.bridge.context.base", "v8-bridge",
     ...
     "synthetic request context evidence; no socket, router, or response writer involved", true, 0U, 0U},
    ...
    {"v8.bridge.context.headers_entries", "v8-bridge",
     ...
     "separate from header lookup so eager entries cost remains visible", true, 0U, 0U},
    {"v8.bridge.context.body_text_json", "v8-bridge",
     ...
     "synthetic body facade evidence; JSON parse cost is included", true, 0U, 0U},
    {"v8.bridge.context.body_bytes", "v8-bridge",
     ...
     "covers zero, embedded NUL, and high-byte request body data", true, 0U, 0U},
