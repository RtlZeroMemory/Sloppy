...
static const SlBenchDefinition v8_bridge_definitions[] = {
    {"v8.startup.create.core_only", "v8-bridge",
     ...
     "internal startup evidence only; includes isolate/context and root intrinsic setup", true},
    {"v8.startup.create.app_http", "v8-bridge",
     ...
     "internal startup evidence only; not request throughput or public performance data", true},
    ...
    {"v8.bridge.call.noop_proxy", "v8-bridge",
     ...
     "public-ABI proxy for handler-call overhead; not a pure V8 Fast API benchmark", true},
    {"v8.bridge.native.time_noarg", "v8-bridge",
     ...
     "includes JS handler entry, native intrinsic call, and text result conversion", true},
    {"v8.bridge.native.crypto_primitive", "v8-bridge",
     ...
     "includes random backend cost; used as bridge evidence, not crypto throughput data", true},
    {"v8.bridge.native.crypto_bytes", "v8-bridge",
     ...
     "exercises byte argument conversion and native text result conversion", true},
    ...
    {"v8.bridge.result.primitive_json", "v8-bridge",
     ...
     "internal result-conversion evidence; no public response throughput claim", true},
    {"v8.bridge.result.string_utf8", "v8-bridge",
     "copy a UTF-8 JavaScript string result into arena-owned native storage", 1000U, 10000U,
     sl_bench_v8_result_string_utf8, "exercises string conversion and result arena copy", true},
    {"v8.bridge.promise.resolve_text", "v8-bridge",
     "convert an already-fulfilled JavaScript Promise resolving to text", 1000U, 10000U,
     sl_bench_v8_promise_resolve_text, "owner-thread microtask drain evidence only", true},
    ...
    {"v8.bridge.promise.reject_error", "v8-bridge",
     ...
     "expected rejection is counted as the measured outcome", true},
    {"v8.bridge.options.invalid_result_header", "v8-bridge",
     ...
     "expected invalid descriptor is counted as the measured outcome", true},
    {"v8.bridge.context.base", "v8-bridge",
     ...
     "synthetic request context evidence; no socket, router, or response writer involved", true},
    {"v8.bridge.context.headers_get", "v8-bridge",
     ...
     "exercises lazy header snapshot lookup without full entries materialization", true},
    {"v8.bridge.context.headers_entries", "v8-bridge",
     ...
     "separate from header lookup so eager entries cost remains visible", true},
    {"v8.bridge.context.body_text_json", "v8-bridge",
     ...
     "synthetic body facade evidence; JSON parse cost is included", true},
