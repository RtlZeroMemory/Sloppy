...
typedef enum SlRuntimeFeatureId
{
    ...
    SL_RUNTIME_FEATURE_STDLIB_TIME = 9,
    SL_RUNTIME_FEATURE_STDLIB_FS = 10,
    SL_RUNTIME_FEATURE_PROVIDER_SQLITE = 11,
    SL_RUNTIME_FEATURE_PROVIDER_POSTGRES = 12,
    SL_RUNTIME_FEATURE_PROVIDER_SQLSERVER = 13,
