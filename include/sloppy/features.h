...
typedef enum SlRuntimeFeatureId
{
    ...
    SL_RUNTIME_FEATURE_STDLIB_JOBS = 20,
    SL_RUNTIME_FEATURE_NODE_COMPAT_PATH = 21,
    SL_RUNTIME_FEATURE_NODE_COMPAT_EVENTS = 22,
    SL_RUNTIME_FEATURE_NODE_COMPAT_URL = 23,
    SL_RUNTIME_FEATURE_NODE_COMPAT_QUERYSTRING = 24,
    SL_RUNTIME_FEATURE_NODE_COMPAT_BUFFER = 25,
    SL_RUNTIME_FEATURE_NODE_COMPAT_UTIL = 26,
    SL_RUNTIME_FEATURE_NODE_COMPAT_TIMERS = 27,
    SL_RUNTIME_FEATURE_NODE_COMPAT_FS = 28,
    SL_RUNTIME_FEATURE_NODE_COMPAT_FS_PROMISES = 29,
    SL_RUNTIME_FEATURE_NODE_COMPAT_OS = 30,
    SL_RUNTIME_FEATURE_NODE_COMPAT_PROCESS = 31,
    SL_RUNTIME_FEATURE_NODE_COMPAT_CRYPTO = 32,
    SL_RUNTIME_FEATURE_STDLIB_FFI = 33,
    SL_RUNTIME_FEATURE_NODE_COMPAT_ASSERT = 34,
    SL_RUNTIME_FEATURE_NODE_COMPAT_STREAM = 35,
    SL_RUNTIME_FEATURE_NODE_COMPAT_CONSOLE = 36,
    SL_RUNTIME_FEATURE_NODE_COMPAT_CONSTANTS = 37,
    SL_RUNTIME_FEATURE_NODE_COMPAT_DIAGNOSTICS_CHANNEL = 38,
    SL_RUNTIME_FEATURE_NODE_COMPAT_HTTP = 39,
    SL_RUNTIME_FEATURE_NODE_COMPAT_HTTPS = 40,
    SL_RUNTIME_FEATURE_NODE_COMPAT_MODULE = 41,
    SL_RUNTIME_FEATURE_NODE_COMPAT_PERF_HOOKS = 42,
    SL_RUNTIME_FEATURE_NODE_COMPAT_STRING_DECODER = 43,
    SL_RUNTIME_FEATURE_NODE_COMPAT_TTY = 44,
    SL_RUNTIME_FEATURE_NODE_COMPAT_ZLIB = 45,
    SL_RUNTIME_FEATURE_COUNT = 46,
