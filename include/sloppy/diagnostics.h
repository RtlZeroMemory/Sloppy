...
typedef enum SlDiagCode
{
    ...
    SL_DIAG_HTTP_CLIENT_MALFORMED_RESPONSE = 162,
    SL_DIAG_HTTP_CLIENT_CONNECT_FAILED = 163,
    SL_DIAG_HTTP_CLIENT_DNS_FAILED = 164,
    SL_DIAG_HTTP_CLIENT_TLS_BACKEND_UNAVAILABLE = 165,
    SL_DIAG_HTTP_CLIENT_TLS_CERTIFICATE_VALIDATION_FAILED = 166,
    SL_DIAG_HTTP_CLIENT_TLS_HOSTNAME_MISMATCH = 167,
    SL_DIAG_HTTP_CLIENT_REQUEST_TIMEOUT = 168,
    SL_DIAG_HTTP_CLIENT_REQUEST_CANCELLED = 169,
    SL_DIAG_HTTP_CLIENT_REDIRECT_LOOP = 170,
    SL_DIAG_HTTP_CLIENT_MAX_REDIRECTS_EXCEEDED = 171,
    SL_DIAG_HTTP_CLIENT_SENSITIVE_HEADER_STRIPPED = 172,
    SL_DIAG_HTTP_CLIENT_POOL_EXHAUSTED = 173,
    SL_DIAG_HTTP_CLIENT_STRICT_NETWORK_DENIED = 174,
    SL_DIAG_HTTP_CLIENT_DYNAMIC_TARGET_METADATA = 175,
    SL_DIAG_WORKERS_FEATURE_UNAVAILABLE = 176,
    SL_DIAG_BACKGROUND_SERVICE_START_FAILED = 177,
    SL_DIAG_BACKGROUND_SERVICE_FAILED = 178,
    SL_DIAG_WORK_QUEUE_FULL = 179,
    SL_DIAG_WORK_QUEUE_STOPPED = 180,
    SL_DIAG_WORK_JOB_CANCELLED = 181,
    SL_DIAG_WORK_JOB_TIMEOUT = 182,
    SL_DIAG_WORK_JOB_FAILED = 183,
    SL_DIAG_WORK_RETRY_EXHAUSTED = 184,
    SL_DIAG_WORKER_POOL_UNAVAILABLE = 185,
    SL_DIAG_WORKER_POOL_SATURATED = 186,
    SL_DIAG_WORKER_CRASHED = 187,
    SL_DIAG_WORKER_RESOURCE_LIMIT_EXCEEDED = 188,
    SL_DIAG_WORKER_MESSAGE_SERIALIZATION_FAILED = 189,
    SL_DIAG_WORKER_ISOLATE_STARTUP_FAILED = 190,
    SL_DIAG_WORKER_UNSUPPORTED_PAYLOAD = 191,
    SL_DIAG_WORKER_SHUTDOWN_CANCELLED = 192,
    SL_DIAG_WORKER_STALE_HANDLE = 193
} SlDiagCode;
