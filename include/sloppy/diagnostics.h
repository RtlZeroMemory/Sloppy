...
typedef enum SlDiagCode
{
    ...
    SL_DIAG_FFI_RUNTIME_UNAVAILABLE = 205,
    SL_DIAG_FFI_LIBRARY_NOT_FOUND = 206,
    SL_DIAG_FFI_SYMBOL_NOT_FOUND = 207,
    SL_DIAG_FFI_UNSUPPORTED_CALLING_CONVENTION = 208,
    SL_DIAG_FFI_INVALID_ARGUMENT_COUNT = 209,
