...
typedef enum SlDiagCode
{
    ...
    SL_DIAG_NET_FEATURE_UNAVAILABLE = 99,
    SL_DIAG_NET_CONNECT_DENIED = 100,
    SL_DIAG_NET_LISTEN_DENIED = 101,
    SL_DIAG_NET_INVALID_HOST = 102,
    SL_DIAG_NET_INVALID_PORT = 103,
    SL_DIAG_NET_DNS_FAILURE = 104,
    SL_DIAG_NET_CONNECT_TIMEOUT = 105,
    SL_DIAG_NET_CONNECT_CANCELLED = 106,
    SL_DIAG_NET_CONNECTION_CLOSED = 107,
    SL_DIAG_NET_STALE_HANDLE = 108,
    SL_DIAG_NET_READ_WRITE_TIMEOUT = 109,
    SL_DIAG_NET_READ_WRITE_CANCELLED = 110,
    SL_DIAG_NET_BACKPRESSURE_OVERFLOW = 111,
    SL_DIAG_NET_UNSUPPORTED_OPTION = 112,
    SL_DIAG_NET_BACKEND_UNAVAILABLE = 113
} SlDiagCode;
