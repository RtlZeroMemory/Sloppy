 ...
 *
 * SL_ENGINE_KIND_NONE creates the deterministic noop engine. SL_ENGINE_KIND_V8 currently
 * returns SL_STATUS_UNSUPPORTED; real V8 initialization is deferred to later EPIC-07 tasks.
 */
