...
typedef enum SlResourceKind
{
    ...
    SL_RESOURCE_KIND_OS_PROCESS = 13,
    SL_RESOURCE_KIND_BACKGROUND_SERVICE = 14,
    SL_RESOURCE_KIND_WORK_QUEUE = 15,
    SL_RESOURCE_KIND_WORKER_POOL = 16,
    SL_RESOURCE_KIND_JS_WORKER = 17,
    SL_RESOURCE_KIND_LIMIT = 18
} SlResourceKind;
