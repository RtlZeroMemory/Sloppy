...
typedef enum SlResourceKind
{
    ...
    SL_RESOURCE_KIND_POSTGRES_CURSOR = 5,
    SL_RESOURCE_KIND_SQLSERVER_CURSOR = 6,
    SL_RESOURCE_KIND_TEST_RESOURCE = 7,
    SL_RESOURCE_KIND_FS_FILE_HANDLE = 8,
    SL_RESOURCE_KIND_FS_LOCK = 9,
    SL_RESOURCE_KIND_FS_WATCH = 10,
    SL_RESOURCE_KIND_TCP_CONNECTION = 11,
    SL_RESOURCE_KIND_TCP_LISTENER = 12,
    SL_RESOURCE_KIND_LOCAL_CONNECTION = 13,
    SL_RESOURCE_KIND_LOCAL_SERVER = 14,
    SL_RESOURCE_KIND_OS_PROCESS = 15,
    SL_RESOURCE_KIND_BACKGROUND_SERVICE = 16,
    SL_RESOURCE_KIND_WORK_QUEUE = 17,
    SL_RESOURCE_KIND_WORKER_POOL = 18,
    SL_RESOURCE_KIND_JS_WORKER = 19,
    SL_RESOURCE_KIND_LIMIT = 20
} SlResourceKind;
