...
function Invoke-ContractsArea {
    ...
    Invoke-ExternalLane "contracts.release" "node" @((Join-Path $Root "tests/contracts/runner/contract-runner.mjs"), "--area", "release", "--tier", $Tier) -UnavailableNote "node is not available"
}
