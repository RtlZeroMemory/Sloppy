...
function Invoke-ContractsArea {
    Invoke-ExternalLane "contracts.pr" "node" @((Join-Path $Root "tests/contracts/runner/contract-runner.mjs"), "--area", "all", "--tier", "pr") -UnavailableNote "node is not available"
}
