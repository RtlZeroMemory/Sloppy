...
const NODE_ASSERT_STRICT_SHIM: &str = r#"const base=require("sloppy/node/assert");const strict={...base,equal:base.strictEqual,default:null};module.exports=strict;module.exports.default=strict;"#;
