...
globalThis.__sloppy_handler_2 = async function(ctx) { try { return await ((() => { const __sloppy_typed_handler = (
  body,
  database,
  clock,
  trace,
