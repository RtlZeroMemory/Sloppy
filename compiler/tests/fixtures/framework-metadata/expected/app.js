...
globalThis.__sloppy_handler_1 = (() => { const __sloppy_typed_handler = async (
  input,
  db,
  audit,
  search,
...
}; return async (ctx) => { const __sloppy_scope = __sloppy_framework_services.createScope(ctx); ctx.services = __sloppy_scope; try { const __sloppy_args = await Promise.all([__sloppy_framework_arg(ctx, __sloppy_scope, {"capability":null,"injectionKind":null,"kind":"route","name":"id","parameter":"id","providerKind":null,"schema":"number","type":"Route<number>","wrapper":"Route"}), __sloppy_framework_arg(ctx, __sloppy_scope, {"capability":null,"injectionKind":null,"kind":"header","name":"x-trace-id","parameter":"trace","providerKind":null,"schema":null,"type":"Header<\"x-trace-id\">","wrapper":"Header"}), __sloppy_framework_arg(ctx, __sloppy_scope, {"capability":null,"injectionKind":null,"kind":"query","name":"includeDeleted","parameter":"includeDeleted","providerKind":null,"schema":"bool","type":"Query<boolean>","wrapper":"Query"}), ctx.body.json(), __sloppy_framework_arg(ctx, __sloppy_scope, {"capability":"data.main","injectionKind":"provider","kind":"injection","name":"main","parameter":"db","providerKind":"postgres","schema":null,"type":"Postgres<\"main\">","wrapper":null}), ctx]); return await __sloppy_typed_handler(...__sloppy_args); } finally { await __sloppy_scope.dispose(); } }; })();
