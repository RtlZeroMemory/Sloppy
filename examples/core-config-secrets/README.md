...
claim, and no benchmark or performance claim. Placeholder configuration values must remain
placeholder-only; real tokens do not belong in examples or goldens.
