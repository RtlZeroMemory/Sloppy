...
provider metadata from `SqlServer<"main">`, semantic request types, and deadline
propagation into provider calls.
...
```powershell
$env:Sloppy__Providers__sqlserver__main__connectionString="Driver={ODBC Driver 18 for SQL Server};Server=localhost;Database=sloppy_test;UID=sa;PWD=<secret>;TrustServerCertificate=yes;"
