...
| `testservices-postgres` | documentation example | Read `examples/testservices-postgres/README.md` | Docker-backed PostgreSQL service with migrations, seed, reset, and TestHost | Requires Docker, the opt-in TestServices gate, and the PostgreSQL provider bridge. |
| `testservices-sqlserver` | documentation example | Read `examples/testservices-sqlserver/README.md` | Docker-backed SQL Server service with migrations, seed, reset, and TestHost | Requires Docker, the opt-in TestServices gate, SQL Server provider bridge, and ODBC driver. |
