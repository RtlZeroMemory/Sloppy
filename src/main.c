...
#define SL_RUN_ARTIFACT_FILE_MAX_BYTES 1048576U
#define SL_RUN_STDLIB_FILE_MAX_BYTES 393216U
...
#define SL_RUN_PLAN_ARENA_BYTES 2097152U
#define SL_RUN_ROUTE_ARENA_BYTES 524288U
#define SL_RUN_MAX_ROUTES 1024U
