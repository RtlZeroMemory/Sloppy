...
#define SL_CLI_MAX_FFI_HANDLES 32U
#define SL_CLI_MAX_FFI_CALLBACKS 32U
#define SL_CLI_MAX_FFI_DISPATCH_TABLES 32U
#define SL_CLI_MAX_FFI_DISPATCH_SYMBOLS 64U
#define SL_CLI_MAX_FFI_ADOPTIONS 64U
