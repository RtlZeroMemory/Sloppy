...
with ENGINE-22.A HTTP adoption, ENGINE-22.C Plan/artifact adoption, ENGINE-22.D V8 bridge
adoption, and the non-SQLite ENGINE-22.F cleanup/regression guard implemented for their
bounded subsystem passes.
...
7. ENGINE-22.F removes duplicate ad hoc buffers/builders, finishes safe symbol adoption,
   and adds regression guards. The non-SQLite cleanup/guard pass is implemented; SQLite
   result/parameter adoption remains separate while ENGINE-22.E is open.
