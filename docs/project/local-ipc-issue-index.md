...
IPC-1 is a policy and contract PR. IPC-next-2 adds native POSIX Unix socket execution but
does not expose successful V8 `LocalEndpoint` calls yet. Windows named pipes, executable V8
local IPC bridge calls, doctor/audit output, examples, public alpha docs, and
