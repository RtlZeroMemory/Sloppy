...
| #608 | V8/stdlib integration and JS surface | Partially implemented by the fail-closed bootstrap surface; native bridge is deferred. |
| #609 | Doctor/audit, conformance, examples, docs, and goldens | Deferred except for contract documentation. |
