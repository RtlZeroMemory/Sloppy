...
Status: CORE-TIME-01.A/B source-of-truth index.
...
| CORE-TIME-01.C/D/G | #554, #555, #558 | Native timer backend, owner-thread completion, delay/timeout/deadline/cancellation, and V8/stdlib surface. |
...
- Future V8 intrinsic namespace: `__sloppy.time`.
