...
## Goal
Create the bounded Sloppy.create + app.mapGet Conceptual API slice for Public TypeScript API Bootstrap.

## Scope
- Implement only the coherent Sloppy.create + app.mapGet Conceptual API slice.
