...
## Goal
Create the bounded SlLoop Interface and Completion Queue Skeleton slice for Event Loop / Concurrency Foundation.

## Scope
- Implement only the coherent SlLoop Interface and Completion Queue Skeleton slice.
