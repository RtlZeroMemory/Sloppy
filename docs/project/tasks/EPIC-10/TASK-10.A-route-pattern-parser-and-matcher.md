...
## Goal
Create the bounded Route Pattern Parser and Matcher slice for HTTP Router Foundation.

## Scope
- Implement only the coherent Route Pattern Parser and Matcher slice.
