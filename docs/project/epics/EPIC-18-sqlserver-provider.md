...
## Summary
Add SQL Server provider through ODBC with driver detection, query/exec/pool, transactions, and missing-driver diagnostics.
...
## Goal
Deliver SQL Server Provider as medium-sized bounded-context PRs.
...
## Task Breakdown
- TASK 18.A: ODBC Provider Skeleton
- TASK 18.B: Query/Exec/Pool
- TASK 18.C: Transactions
- TASK 18.D: Missing Driver Diagnostics
