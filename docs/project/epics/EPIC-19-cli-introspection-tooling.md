...
## Summary
Add Sloppy Plan-powered routes, doctor, audit, and openapi commands without running user handlers.
...
## Goal
Deliver CLI Introspection Tooling as medium-sized bounded-context PRs.
...
- TASK 19.B: sloppy doctor
- TASK 19.C: sloppy audit
- TASK 19.D: sloppy openapi skeleton
