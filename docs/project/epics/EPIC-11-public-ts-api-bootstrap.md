...
## Summary
Introduce the tiny Sloppy API facade, Results basics, and first hello example after runtime contract exists.
...
## Goal
Deliver Public TypeScript API Bootstrap as medium-sized bounded-context PRs.
...
## Task Breakdown
- TASK 11.A: Bootstrap stdlib layout
- TASK 11.B: Results.text/json
- TASK 11.C: Sloppy.create + app.mapGet Conceptual API
- TASK 11.D: examples/hello
