...
## Summary
Add PostgreSQL provider through libpq with pool, transactions, and doctor diagnostics when dependency phase opens.
...
## Goal
Deliver PostgreSQL Provider as medium-sized bounded-context PRs.
...
- TASK 17.B: Query/Exec/Pool
- TASK 17.C: Transactions
- TASK 17.D: Driver/Doctor Diagnostics
