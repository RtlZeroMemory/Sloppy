...
## Summary
Add declarative module API skeleton, phases, dependency graph, plan contribution, and diagnostics.
...
## Goal
Deliver Modularity / App Modules as medium-sized bounded-context PRs.
...
## Task Breakdown
- TASK 14.A: Sloppy.module API Skeleton
- TASK 14.B: Module Phases and Dependency Graph
- TASK 14.C: Module Plan Contribution
- TASK 14.D: Module Diagnostics
