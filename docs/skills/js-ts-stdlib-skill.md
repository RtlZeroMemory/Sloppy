...
4. Do not add or imply Node, npm, package-manager, Bun, Deno, bundler, or transpiler
   compatibility.
...
11. Do not claim public alpha readiness, production readiness, provider maturity, V8
    readiness, or performance from API-shape examples, fixtures, or static checks.
