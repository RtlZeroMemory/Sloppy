...
| Diagnostics | Yellow | Stable codes, text/JSON/source-frame rendering, redaction helpers, provider/runtime diagnostics, compiler source maps with deterministic Sloppy metadata. | Runtime consumption of compiler source maps, richer CLI format plumbing, structured fixes. |
