...
| HTTP foundation | Yellow | Bounded parser/body/response/dispatch, backend lifecycle, libuv localhost transport, sequential HTTP/1.1 keep-alive, idle timeout, max requests, lifecycle reset. | Chunked/streaming bodies, production graceful drain, TLS/HTTP2/3/WebSockets, middleware, broader stress. |
