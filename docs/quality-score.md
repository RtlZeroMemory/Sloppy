...
COMPILER-30.E adds provider/config/schema/request/result metadata evidence. Effect,
capability, completeness, strong Plan, and realistic fixture-suite inference remains open.
