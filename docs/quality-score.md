...
| Codec APIs | Red | CORE-CODEC-01.A/B defines the public `sloppy/codec` contract, `stdlib.codec` feature descriptor, compiler Plan activation, backend/dependency policy, stable diagnostics, and non-security checksum boundary. | Base64/Base64Url/Hex/Text/Binary/Compression/Checksums implementation, V8/stdlib surface, examples, and conformance evidence remain unimplemented. |
