...
| Runtime execution plan | Yellow | Execution model is documented, minimal Plan v1 structs exist, and the parser validates a documented golden fixture matrix into arena-owned native data. | Add file-based loader, runtime compatibility checks, V8 smoke, and handwritten execution tests later. |
