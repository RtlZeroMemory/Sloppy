...
static validation, strong Plan metadata, and compatibility goldens. Non-database provider
adapters, imported/repository/service inference, and realistic
