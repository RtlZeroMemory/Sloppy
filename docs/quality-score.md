...
| Runtime execution plan | Yellow | Execution model is documented, minimal Plan v1 structs/fixtures exist, and TASK 06.B parses/validates handwritten plan JSON into arena-owned native data. | Add file-based loader, runtime compatibility checks, V8 smoke, and handwritten execution tests later. |
