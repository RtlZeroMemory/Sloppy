...
| Runtime execution plan | Yellow | Execution model is documented and minimal Plan v1 structs/fixtures now define the first artifact contract shape. | Add plan loader, V8 smoke, and handwritten execution tests later. |
