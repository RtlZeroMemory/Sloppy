...
- packaging claims and non-claims.
...
Dependency availability and feature behavior are separate evidence questions.

- A dependency can be installed while a feature lane is still unproven.
